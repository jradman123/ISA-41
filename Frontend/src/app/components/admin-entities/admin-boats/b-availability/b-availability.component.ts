...
@Component({
  selector: 'app-b-availability',
  templateUrl: './b-availability.component.html',
  styleUrls: ['./b-availability.component.css']
})
export class BAvailabilityComponent implements OnInit {
