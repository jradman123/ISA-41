...
public class UserDTO {
	...
	public UserDTO(User user) {
		this(user.getId(), user.getFirstName(), user.getLastName(), user.getPassword(),user.getDateOfBirth(),user.getEmail(),user.getPhoneNumber(),user.getAddress(),user.getJmbg(),user.getDescriptionOfRegistration(),user.getIsActivated());
	}

	
	
	public UserDTO(Integer id, String firstName, String lastName, String password, LocalDate dateOfBirth, String email,
			String phoneNumber, Address address, String jmbg, String descriptionOfRegistration, Boolean isActivated) {
		super();
		this.id = id;
