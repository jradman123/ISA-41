...
@Component({
  selector: 'app-c-availability',
  templateUrl: './c-availability.component.html',
  styleUrls: ['./c-availability.component.css']
})
export class CAvailabilityComponent implements OnInit {
